...
public class KerberosUtil {
   ...
   */
  public static final String KERBEROS_APP_NAME = "hadoop-user-kerberos";
  ...
  public LoginContext getLoginContextFromKeytab( String principal, String keytab ) throws LoginException {
    ...
    return new LoginContext( KERBEROS_APP_NAME+System.currentTimeMillis(), subject, null, new PentahoLoginConfiguration( configEntries ) );
  }
