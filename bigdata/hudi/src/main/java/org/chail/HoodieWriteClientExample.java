    ...
    public static void main(String[] args) throws Exception {
        ...
        try (JavaSparkContext jsc = new JavaSparkContext(sparkConf)) {
            ...
            if (!fs.exists(path)) {
                ...
                propertyBuilder.setTableName(tableName);
                propertyBuilder.setPayloadClass(HoodieAvroPayload.class);
                propertyBuilder.setTableType(tableType);
            ...
            HoodieWriteConfig cfg =
                    HoodieWriteConfig.newBuilder()
                            .withPath(tablePath)
                            .withSchema(DataSchemaProviderExample.TRIP_EXAMPLE_SCHEMA)
                            .withParallelism(2, 2)
            ...
            if (HoodieTableType.valueOf(tableType) == HoodieTableType.MERGE_ON_READ) {
                ...
                JavaRDD<WriteStatus> writeStatues = client.compact(instant.get()).getWriteStatuses();
                client.commit(instant.get(), writeStatues, Option.empty());
