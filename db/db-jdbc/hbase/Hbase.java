package com.chail.apputil.jdbc.hbase;
...
import org.apache.hadoop.hbase.util.Bytes;import com.amazonaws.services.opsworks.model.StackAttributesKeys;
...
public class Hbase {
    ...
    static {
        ...
        conf.set("hbase.zookeeper.quorum", "192.168.241.104");
    }
    ...
    public static void creatTable(String tableName, String[] family)
        ...
        //admin.createTable(arg0, arg1);e(desc, StackAttributesKeysy, endKey, numRegions);
    ...
    public static void scanAll(String tableName) throws IOException {
    	 ...
    	 for(TableName tableNames:listTableNames) {
    		 List<HRegionInfo> tableRegions = admin.getTableRegions(tableNames);
    		 tableRegions.forEach(o->{o.getEndKey();});
    	 }
    ...
    public static void main(String[] args) throws Exception {
    	...
    	scanAll("GPSTEST");
        // 创建表
        String tableName = "pentaho_mappings";
        String[] family = { "columns", "key" };
