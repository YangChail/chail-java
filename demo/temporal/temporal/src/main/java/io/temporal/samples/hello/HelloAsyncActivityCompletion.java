...
public class HelloAsyncActivityCompletion {
  ...
  static class GreetingActivitiesImpl implements GreetingActivities {
    ...
    public String composeGreeting(String greeting, String name) {
      ...
      /**
       * For the example we will use a {@link ForkJoinPool} to execute our
  ...
  public static void main(String[] args) throws ExecutionException, InterruptedException {
    ...
    /**
     * Here we use {@link WorkflowClient} to execute our workflow asynchronously.
     * It gives us back a {@link CompletableFuture}. We can then call its get
