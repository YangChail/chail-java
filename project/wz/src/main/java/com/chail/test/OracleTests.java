package com.chail.test;

import com.alibaba.druid.pool.DruidDataSource;
import com.alibaba.druid.pool.DruidPooledConnection;
import com.chail.datasupport.tools.CloseUtils;
...
public class OracleTests {
    ...
    public static void getConnection() throws ClassNotFoundException, SQLException {
        ...
        dataSource.setUsername("com/chail");
        dataSource.setPassword("com/chail");
        ...
        Connection connection = DriverManager.getConnection("jdbc:oracle:thin:@//192.168.52.173:1521/ora11g", "com/chail", "com/chail");
